<?php $__env->startSection('title', trans('admin.design.actions.index')); ?>

<?php $__env->startSection('body'); ?>

    <design-listing
        :data="<?php echo e($data->toJson()); ?>"
        :url="'<?php echo e(url('admin/designs')); ?>'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> <?php echo e(trans('admin.design.actions.index')); ?>

                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="<?php echo e(url('admin/designs/create')); ?>" role="button"><i class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.design.actions.create')); ?></a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'"><?php echo e(trans('admin.design.columns.id')); ?></th>
                                        <th is='sortable' :column="'title'"><?php echo e(trans('admin.design.columns.title')); ?></th>
                                        <th is='sortable' :column="'description'"><?php echo e(trans('admin.design.columns.description')); ?></th>
                                        <th is='sortable' :column="'enabled'"><?php echo e(trans('admin.design.columns.enabled')); ?></th>
                                    ...
                                    <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="6">
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3" @click="bulkDelete('/admin/designs/bulk-destroy')"><?php echo e(trans('brackets/admin-ui::admin.btn.delete')); ?></button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="<?php echo e(url('admin/designs/create')); ?>" role="button"><i class="fa fa-plus"></i>&nbsp; <?php echo e(trans('admin.design.actions.create')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('brackets/admin-ui::admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/betulerkantarci/Desktop/artB/resources/views/admin/design/index.blade.php ENDPATH**/ ?>