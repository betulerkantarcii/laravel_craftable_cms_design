        ...
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('<?php echo e($col['name']); ?>_{{ $locale }}'), 'has-success': fields.<?php echo e($col['name']); ?>_{{ $locale }} && fields.<?php echo e($col['name']); ?>_{{ $locale }}.valid }">
                ...
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <?php if(in_array($col['name'], $translatableTextarea)): ?><div>
                        <textarea v-model="form.<?php echo e($col['name']); ?>.{{ $locale }}" v-validate="'<?php echo implode('|', $col['frontendRules']); ?>'" @input="validate($event)" class="hidden-xs-up" id="<?php echo e($col['name']); ?>_{{ $locale }}" name="<?php echo e($col['name']); ?>_{{ $locale }}"></textarea>
                        <quill-editor v-model="form.<?php echo e($col['name']); ?>.{{ $locale }}" :options="wysiwygConfig" />
                    </div>
...
<?php $__currentLoopData = $relations['belongsToMany']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $belongsToMany): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div class="form-group row align-items-center" :class="{'has-danger': errors.has('<?php echo e($belongsToMany['related_table']); ?>'), 'has-success': fields.<?php echo e($belongsToMany['related_table']); ?> && fields.<?php echo e($belongsToMany['related_table']); ?>.valid }">
    <label for="<?php echo e($belongsToMany['related_table']); ?>" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'"><?php echo e('{{'); ?> trans('admin.<?php echo e($modelLangFormat); ?>.columns.<?php echo e(lcfirst($belongsToMany['related_model_name_plural'])); ?>') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/betulerkantarci/Desktop/artB/vendor/brackets/admin-generator/src/../resources/views/templates/admin-user/form.blade.php ENDPATH**/ ?>